//this is the google apps script which need to be attached to the form response spreadsheet
...
function onFormSubmit(e) {
  ...
  var userSh = SpreadsheetApp.getActiveSpreadsheet().getSheetByName('Users');
  Logger.log('on formsunmit is running');
...
function createNewView(){
  ...
  runSqlWithRetry(query.join('')); 
    ...
    Logger.log('Error at line :'+err.line +" message is "+err.message +"    " + err)}
}
